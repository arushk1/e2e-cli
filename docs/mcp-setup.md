...
- **Security Groups:** `e2e_security_group_list`, `e2e_security_group_get`
- **Firewalls:** `e2e_firewall_list`, `e2e_firewall_get`, `e2e_firewall_create`, `e2e_firewall_delete`
- **DNS:** `e2e_dns_list_zones`, `e2e_dns_get_zone`, `e2e_dns_list_records`, `e2e_dns_create_record`, `e2e_dns_delete_record`
- **Reserve IPs:** `e2e_reserve_ip_list`, `e2e_reserve_ip_get`, `e2e_reserve_ip_create`, `e2e_reserve_ip_delete`
